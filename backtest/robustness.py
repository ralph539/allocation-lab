...
Answers one question: does the risk-profiled mean-CVaR engine hold up outside the
...
Universes:
  us_book_noAI   the ETF universe without the AI sleeve (diagnostic)
...
def build_universes() -> dict:
    ...
    out["us_book_noAI"] = reduce_universe(cfg, raw, AI_NAME)
